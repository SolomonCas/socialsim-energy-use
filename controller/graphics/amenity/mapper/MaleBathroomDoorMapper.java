...
public class MaleBathroomDoorMapper extends AmenityMapper {
    ...
    public static void draw(List<Patch> patches, String facing) {
        for (Patch patch : patches) {
            ...
            Amenity.AmenityBlock.AmenityBlockFactory amenityBlockFactory = MaleBathroomDoor.MaleBathroomDoorBlock.maleBathroomDoorBlockFactory;
            ...
            MaleBathroomDoor doorToAdd = MaleBathroomDoor.MaleBathroomDoorFactory.create(amenityBlocks, true, facing);
            Main.simulator.getEnvironment().getMaleBathroomDoors().add(doorToAdd);
