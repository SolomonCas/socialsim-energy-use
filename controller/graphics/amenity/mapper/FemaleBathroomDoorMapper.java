...
import com.socialsim.model.core.environment.patchobject.passable.goal.FemaleBathroomDoor;

import java.util.ArrayList;
import java.util.List;

public class FemaleBathroomDoorMapper extends AmenityMapper {
    ...
    public static void draw(List<Patch> patches, String facing) {
        for (Patch patch : patches) {
            ...
            Amenity.AmenityBlock.AmenityBlockFactory amenityBlockFactory = FemaleBathroomDoor.FemaleBathroomDoorBlock.femaleBathroomDoorBlockFactory;
            ...
            FemaleBathroomDoor doorToAdd = FemaleBathroomDoor.FemaleBathroomDoorFactory.create(amenityBlocks, true, facing);
            Main.simulator.getEnvironment().getFemaleBathroomDoors().add(doorToAdd);
