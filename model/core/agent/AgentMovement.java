        ...
        if(this.goalAmenity == null){
            ...
            for (Amenity amenity : amenityListInFloor) {
                if (parent.getType() == Agent.Type.DIRECTOR) {
                    if (amenity.getAmenityBlocks().get(0).getPatch().getPatchField().getValue() == 3) {
                ...
                else if (parent.getGender() == Agent.Gender.MALE) {
        ...
        while (!openSet.isEmpty()) {
            ...
            for (Patch patchToExploreNeighbor : patchToExploreNeighbors) {
                if ((patchToExploreNeighbor.getAmenityBlock() == null && patchToExploreNeighbor.getPatchField() == null)
                        ...
                        || (patchToExploreNeighbor.getAmenityBlock() != null && patchToExploreNeighbor.getAmenityBlock().getParent().getClass() == ReceptionTable.class)
...
//                }
                temp.add(this.environment.getChairs().get(12));
                temp.add(this.environment.getChairs().get(13));
...
//                    temp.add(this.office.getChairs().get(i));
//                }
                temp.add(this.environment.getChairs().get(14));
                temp.add(this.environment.getChairs().get(15));
