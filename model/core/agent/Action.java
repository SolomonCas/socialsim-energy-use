...
public class Action {
    ...
    public enum Name {
        ...
        GO_TO_FACULTY_ROOM(), GO_TO_DIRECTOR_ROOM(), GO_TO_CONTROL_PANEL(), GO_TO_PANTRY(),
        GO_TO_LEARNING_SPACE(), GO_TO_RESEARCH_CENTER(), GO_TO_SOLO_ROOM(), GO_TO_DATA_COLLECTION_ROOM(),
        GO_TO_HUMAN_EXPERIENCE_ROOM(), GO_TO_MEETING_ROOM(),
